...
Use separately configured google-drive, google-docs, google-sheets connections only after confirming native host support, available tool schemas and human OAuth consent.
